      ...
      <div className='fixed bottom-0 z-50 w-full p-2 bg-white shadow-lg'>
        <div className='flex justify-between items-baseline'>
          <Link className='flex items-center flex-col gap-1 text-gray-500' to={'/'}>
            ...
            <span className={`text-[10px] font-semibold ${location.pathname === '/' ? 'text-blue-500' : 'text-gray-500'}`}>
              Home
            </span>
          </Link>
          ...
          <Link className='flex items-center flex-col gap-1 text-gray-500' to={'/categories'}>
            ...
            <span className={`text-[10px] font-semibold ${location.pathname === '/categories' ? 'text-blue-500' : 'text-gray-500'}`}>
              Categories
            </span>
          </Link>
          ...
          <Link className='flex items-center flex-col gap-1 text-gray-500' to={'/campaign/explore'}>
            ...
            <span className={`text-[10px] font-semibold ${location.pathname === '/explore' ? 'text-blue-500' : 'text-gray-500'}`}>
              Explore
            </span>
          </Link>
          ...
          <Link className='flex items-center flex-col gap-1 text-gray-500' to={'/myaccount'}>
            ...
            <span className={`text-[10px] font-semibold ${location.pathname === '/myaccount' ? 'text-blue-500' : 'text-gray-500'}`}>
              Profile
            </span>    
          </Link>
        </div>
